---
title: "Continuous Critique While Writing"
tags: [memory, feedback, writing]
aliases: [continuous-critique-while-writing]
origin_session: "550738ca-b59f-4360-8769-8fe68272333d"
source_memory: "/home/centcom/.claude/projects/-home-centcom-data-brain-alignment/memory/continuous-critique-while-writing.md"
---
...
**How to apply:** after drafting each source-complete section or batch, run the panel briefed with the review-pass lenses: internal/external validity, so-what, first-pass readability, plus an explicit writing-quality lens. Verify each objection against the source evidence, apply the ones that hold, and re-run until no hole survives.
