---
description: Enter the write stance and draft settled evidence directly into the canonical rewrite manuscript.
...
3. Draft directly into `docs/manuscript/rewrite/`; do not create an intermediate report or lattice.
