...
5. **Ladder integrity.** Every rung status matches an `experiments/` record; partials carry their caveat; the "Next session" block is concrete and stance-tagged; kill criteria still predeclared for open rungs. (This is the one file the whole continuity process trusts.)
