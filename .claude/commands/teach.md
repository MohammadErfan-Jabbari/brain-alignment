---
description: Enter the teach stance — a guided-learning walkthrough of anything in the repo (a concept, report, file, experiment, paper, or question), grounded in the source and rendered where the terminal can't show math, that transfers understanding into your head.
argument-hint: <subject — e.g. R07, "knowledge distillation", a file path, E0nn, a paper, or a question> [guided|walkthrough|feynman|drill]
...
- Teach **anything**: a concept, a finding-report, a code file, an experiment (and why it's designed that
