---
description: Enter the plan stance — set direction: roadmap, kill-gate triage, what to run next. Produces no number, flips no rung.
argument-hint: <the question, e.g. "what's the next door after Q3">
