...
# warning, NOT a hard gate: an opus review showed dual-use verbs (enable/achieve/establish/deliver) make a
# HARD rule false-positive on legitimate Methods/Results triples, and the ecosystem audit places tricolon in
# the auditor's territory. So SC-VOICE-06 is owned by the RUB prose-register-auditor; this regex is its lead.
