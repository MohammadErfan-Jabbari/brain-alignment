...
declare -a S1=(Qwen/Qwen2.5-3B facebook/opt-2.7b EleutherAI/pythia-2.8b unsloth/Llama-3.2-3B)
...
declare -a S3=(EleutherAI/pythia-70m EleutherAI/pythia-160m EleutherAI/pythia-410m EleutherAI/pythia-1b \
               facebook/opt-125m facebook/opt-350m facebook/opt-1.3b Qwen/Qwen2.5-0.5B unsloth/Llama-3.2-1B)
