...
- **Where things live:** canonical status → `ladder.md`; the slow narrative → `reports/R05`; the analysis-week plan → `analysis-roadmap.md`; experiments → `experiments/E*.md`; decisions/lessons → `decisions/decisions.md` + `learnings.md`.
