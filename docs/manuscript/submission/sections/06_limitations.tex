...
The routes therefore run in different model families, and each is evaluated only against its own control under the eligibility rule in Section~\ref{sec:estimands}, so no result compares one route with the other and no reported contrast depends on the family difference.
