...
\looseness=-1 The tables preserve the distinction between inference units.
...
& Saved-student biological-transfer assay and 50-component linear target-projection assay
    ...
    & Synthetic-target recovery assay; retained-student movement audit; saved-student target-retention analysis; saved-student biological-transfer assay; composed-path diagnostic. The saved student and the retained student are the same post-training model
    & Confirmatory
