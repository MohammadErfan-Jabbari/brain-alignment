...
& Saved-student biological-transfer assay and 50-component linear target-projection measurability assay
  & Scope-bounding
...
& Controlled naturalistic voxelwise predictivity assay; recorded-response intervention; saved-student biological-transfer assay; 50-component linear target-projection measurability assay
  & Scope-bounding
& The naturalistic assay remains a one-participant result. No leave-one-block-out intervention analysis produced a positive participant-mean contrast that changed the participant-level disposition, and the linear target-projection result survived every block deletion.\evd{E006}\evd{E008}\evd{E025}\evd{E030} \\
