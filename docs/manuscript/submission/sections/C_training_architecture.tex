...
Two route types recur below. An unanchored route trains the student without a teacher and keeps language quality with its own next-token objective, and a teacher-anchored route adds output \ac{kd} from a frozen teacher. \evd{E003}\evd{E005}\evd{E016}
\end{samepage}
...
Replay requires four linked objects. These are the locked software environment, the executed entry point and arguments, the declared seed and final-state rule, and the retained result or student artifact.
