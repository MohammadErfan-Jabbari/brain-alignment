...
Reproducing a run requires four linked objects: the locked software environment, the executed entry point and arguments, the declared seed and final-state rule, and the retained output.
