...
Replay requires four linked objects.
These are the locked software environment, the executed entry point and arguments, the declared seed and final-state rule, and the retained result or student artifact.
