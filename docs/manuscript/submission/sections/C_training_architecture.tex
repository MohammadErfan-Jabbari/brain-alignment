...
The practical-utility evaluation trained a Qwen2.5-0.5B student against a Qwen2.5-1.5B teacher at hidden-state index 12, seeds 0 to 7, target weight 10, 800 training items, three epochs, learning rate \(2\times10^{-4}\), and batch size 16, then scored 400 items from each out-of-domain corpus. \evd{E009}
