...
\begin{table}[H]
  ...
  \begin{tabular}{@{}>{\raggedright\arraybackslash}p{27mm} >{\raggedright\arraybackslash}p{66mm} >{\raggedright\arraybackslash}p{59mm}@{}}
    ...
    \textcite{bilgin2026} &
    Participant-\ac{fmri} cosine loss and token loss update upper-layer adapters; held-out encoding, new-participant readouts, and a model-specific external task improve. &
    No shuffled or matched text-derived target, smaller student, or ordinary-\ac{kd} comparator. \\
    \textcite{merlinData2026} &
    Participant-\ac{fmri}, stimulus-language, or joint objectives update adapters; brain-response training wins more linguistic-probe comparisons than stimulus tuning. &
...
A structure-preserving permutation changes the pairing between stimuli and targets while preserving the target distribution, testing whether the correct pairing matters.
