...
The \result{e030_practical_threshold} unique-\(R^2\) rule was inherited prospectively to decide whether participant-level biological transfer justified a matched-control follow-up, then frozen as a reference for the target-projection assay. \evd{E025}\evd{E030}
