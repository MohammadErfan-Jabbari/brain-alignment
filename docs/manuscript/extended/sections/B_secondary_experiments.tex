...
The three checked Qwen pair slopes were $+0.334$, $-0.217$, and $+0.076$, so none cleared the decisive saturated-regime requirement. \evd{E023}
The analysis-only gate marked a lower-quality pilot as feasible but did not clear a decisive training comparison; no inferential unit or hypothesis test was claimed for this descriptive screen.
