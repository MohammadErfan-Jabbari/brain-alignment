...
\noindent\textcolor{red}{\textbf{Note.} The contribution list is intentionally granular in this progress draft, so you can see the pieces I am currently tracking. In a later manuscript version I will curate and focus it down to a smaller set of main contributions once the remaining results sections are consolidated.}
...
\begin{itemize}[noitemsep,topsep=2pt]
  ...
  \item It shows within a deeply sampled participant that the trained-minus-untrained signal survives whole-story splits, a capacity-matched nuisance floor, and held-out voxel selection; participant-level generality remains open \evd{E006}.
  ...
  \item It shows that the apparent alignment-objective gain is not reliable at the valid fold-level inference unit and remains entangled with language-model quality \evd{E004}.
\end{itemize}
...
The first three are settled here: the signal survives the recorded controls within UTS03 \evd{E006}; plain distillation leaves alignment headroom but is quality-entangled \evd{E003}; and the tested alignment objective does not show a reliable fold-level gain \evd{E004}.
