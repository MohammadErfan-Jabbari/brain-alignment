...
\begin{itemize}[noitemsep,topsep=2pt]
  ...
  \item It bounds practical payoff: no OOD-perplexity benefit is detected when the alignment manipulation is unreliable, while a separate gaze-privileged route fails its informativeness and split-stability gates before training \evd{E009}\evd{E024}.
\end{itemize}
