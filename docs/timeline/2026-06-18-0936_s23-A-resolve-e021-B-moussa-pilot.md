...
**Recording task:** documented the literature-sweep system ([`docs/references/literature-sweep-system.md`](../references/literature-sweep-system.md)) + the future "fetch-once, query-forever" conference corpus → far-future task in [`tasks.md`](../tasks.md) + gbrain. The exhaustive sweep was deliberately deferred (Erfan agreed it's a separate future build).
