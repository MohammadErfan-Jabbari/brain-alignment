...
## Parked / open
- **E006 voxel-bootstrap CI = a `/interpret` item** (a ✅-rung result reports a pseudo-replicated CI). The panel's fold-level recompute is a **lead to verify, not a fact**. Do NOT run before the handoff is built. Tracked in [`tasks.md`](../tasks.md).
