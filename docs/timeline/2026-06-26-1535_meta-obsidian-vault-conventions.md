...
- **`fda5a1b`** — frontmatter (title/tags/aliases) + a `## Related` footer on 183 docs (deterministic script), so the graph connects with [`ladder.md`](../ladder.md) + [`map.md`](../map.md) as hubs.
...
## Related
- [`ladder.md`](../ladder.md) — the canonical status board (Q0–Q5 unchanged)
- [`upspeed.md`](../upspeed.md) — current state
