...
5. **Fused the model into the repo's governing surfaces** (D035): the decision record, a `CLAUDE.md` behavioral rule (route writing through the skill; never auto-update the extended/public manuscript), the [`docs/README.md`](../README.md) map rows, and the now-corrected [`docs/manuscript/README.md`](../manuscript/README.md) (dropped "paper and report are the same document" / "no separate latest copy") and [`docs/reports/README.md`](../reports/README.md). Commit `0f101fe`.
