...
- `docs/references/scientific-writing-methodology.md` — the established writing canon: Gopen-Swan (topic/stress,
...
- `docs/references/writing-skills-ecosystem-audit.md` — per-repo scorecard, the convergent model, and the ranked
...
- `docs/references/supervisor-feedback.md` — Claudio's (IMDEA) feedback on the v0.1 manuscript: storytelling
...
- `docs/references/scientific-writing.md` — short stub/pointer (29 lines; not a real asset, flagged).
