...
**Type:** program design + identification framework. **Status:** DESIGN-ONLY PROGRAM; the analysis-only E023a-prime slope/knee gate ran on 2026-07-02, but no training intervention ran. **Created:** 2026-06-18 (S24, analysis). **Owner:** Erfan. **Gate:** any training requires `oracle-reviewer` PASS + a thesis-vs-paper scope decision.
