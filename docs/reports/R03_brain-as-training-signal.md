...
*Note: rungs use the canonical Qn labels (climb order Q0→Q5; see `../map.md`); they appear here in the original conceptual grouping, not climb order.*
