...
The twelve notes are in `docs/literature/canonical/`. The short ids used throughout: [`moussa-2025`](../literature/canonical/moussa-2025_brain-tuning-speech-lms.md) (ICLR'25 speech), [`moussa-2025b`](../literature/canonical/moussa-2025b_multi-participant-brain-tuning.md) (NeurIPS'25 multi-participant), [`moussa-2025c`](../literature/canonical/moussa-2025c_brain-tuned-processing-stages.md) (Interspeech'25 processing-stages), [`bilgin-2026`](../literature/canonical/bilgin-2026_brain-informed-lm-training.md) (ICLR'26 text LMs), [`merlin-2026`](../literature/canonical/merlin-2026_when-lms-lose-their-mind.md) (ICLR'26 causal), [`oota-2026`](../literature/canonical/oota-2026_brain-encoding-scale-compression.md) (= arXiv 2602.07547, the compression counter-evidence), [`cheng-2026`](../literature/canonical/cheng-2026_abstraction-induces-brain-alignment.md) / [`yu-2026`](../literature/canonical/yu-2026_intrinsic-dimension-alignment-generalization.md) (intrinsic-dimension theory), [`groger-2026`](../literature/canonical/groger-2026_aristotelian-platonic-representation.md) (Aristotelian/Platonic), [`pirlot-2022`](../literature/canonical/pirlot-2022_dcca-neural-regularizer-cnns.md) (vision DCCA precedent), [`pepino-2026`](../literature/canonical/pepino-2026_better-audio-reps-more-brain-like.md) and [`freteault-2025`](../literature/canonical/freteault-2025_auditory-ann-fmri-finetuning.md) (audio).
...
|---|---|---|
| **model GROWN** | the classical brain-score literature: [Gao 2024](../literature/canonical/gao-2024_scaling-not-instruction-brain-alignment.md), [Oota 2023](../literature/canonical/oota-2023_joint-linguistic-processing-brain-lms.md), [Pepino 2026](../literature/canonical/pepino-2026_better-audio-reps-more-brain-like.md) (cross-model corr.), Cheng/Yu (correlational LID) | **brain-tuning** — Moussa (speech), **Bilgin (text)**, Merlin (text, causal). **SCOOPED.** |
| **model SHRUNK** | **[Oota 2026](../literature/canonical/oota-2026_brain-encoding-scale-compression.md) / 2602.07547** — alignment under quantization + pruning (the "counter-evidence"). KD *not even measured here*. | **F1: alignment-guided distillation at matched student budget. EMPTY CELL.** |
...
| Neural-data DCCA regularizer (monkey IT) improved CNN accuracy + adversarial robustness (Federer 2022) | `pirlot-2022` | **WRONG on attribution + OVERSTATED** | It is **[Pirlot et al. 2022](../literature/canonical/pirlot-2022_dcca-neural-regularizer-cnns.md), not Federer**; **monkey V1, not IT**. Accuracy +4.9pp and FGSM robustness improved — but a **shuffled-label control reproduces the accuracy gain within 0.4%**; only the *robustness* gain needs real neural structure. |
...
- **Insert a new rung Q1 (the cheap gate): measure whether perplexity-only KD preserves or destroys alignment**, the `oota-2026`-style measurement transposed to distillation. This is question 6(a), needs no training, and gates the entire distillation thesis. Run it before Q3. *(Done — **E003, 2026-06-10**. Verdict: **PARTIAL headroom.** Perplexity-only KD does not preserve alignment for free — a monotone gradient (conventional gpt2 ≈ teacher > warm-KD ρ′=0.84 > distilgpt2 0.60 > from-scratch cold-KD 0.37 > floor), from-scratch logit KD far below teacher (Δ=0.018, p<0.001). BUT the "sheds alignment *beyond* perplexity" claim is unresolved: alignment co-varies with LM quality (Pearson −0.88 on log-ppl, the pure-KD point sits on the curve), the KD-specific dissociation is only p≈0.1, and the cold arm is under-trained (ppl 4.5× teacher). So F1 is neither in the preserve-by-default trap nor confirmed. The resolving experiment is **alignment-guided vs perplexity-only KD at *matched perplexity*** (not just matched budget) + LeBel voxelwise power + a converged cold arm. See `experiments/E003_*.md`, learnings L011.)*
