...
**Sources:** synthesized from `docs/literature/canonical/` + [`docs/01-research-landscape.md`](../01-research-landscape.md).
**Literature freshness:** some per-paper specifics here predate the full-PDF re-reads in [`R04_gap-analysis.md`](R04_gap-analysis.md) — **R04 carries the authoritative corrections** (e.g. the neural-data-regularizer precedent is **[Pirlot 2022](../literature/canonical/pirlot-2022_dcca-neural-regularizer-cnns.md) / monkey V1**, not Federer / IT, and a shuffled-label control there reproduced the accuracy gain; the causal-necessity result is **[Merlin & Toneva 2026](../literature/canonical/merlin-2026_when-lms-lose-their-mind.md)**). Where this report and R04 differ on a literature detail, R04 wins.
**Scope:** what the mapping *is*, what *drives* it, how it *behaves* under scale/compression, and how to *measure* it honestly. This is the foundation the thesis stands on; the distillation use case itself is out of scope here (see [`00-charter.md`](../00-charter.md) and [`R03`](R03_brain-as-training-signal.md)).
...
|---|---|---|
| **Syntax dominates the layer trend** | Strip out probed properties and alignment drops; *syntactic* ones (constituent structure, tree depth) drive the strongest layerwise effect. Semantics is more region-specific. A residual remains after removing everything tested → our feature list is incomplete. | [Oota 2023](../literature/canonical/oota-2023_joint-linguistic-processing-brain-lms.md) |
| **A piece survives "it's just next-word prediction"** | Using two perturbations (scrambling the input, tuning to the stimulus), positive alignment *survives* in language regions (IFG, AG) even after controlling for word-level info **and** next-word prediction. | [Merlin & Toneva 2024](../literature/canonical/merlin-2024_beyond-next-word-brain-alignment.md) |
| **The objective shapes it, not just size** | Fine-tuning long-context models to *summarize narratives* raises alignment — and the gain is **not** explained by better language-model loss. Some models align *better* while their LM loss gets *worse*. | [Aw & Toneva 2023](../literature/canonical/aw-2023_narrative-summarization-improves-brain-alignment.md) |
| **Raw scores can be hollow** | Text models keep above-chance alignment in late language regions after low-level features are removed; *speech* models collapse to chance — their apparent "semantics" was mostly low-level phonology. | [Oota 2024](../literature/canonical/oota-2024_speech-lms-lack-brain-semantics.md) |
...
| **G2** | **Own-data anchor — ✅ largely resolved by E002.** Until this pass every number here was from the literature; E001 ran only on *synthetic* fMRI (plumbing, not science — L004). **E002 has since produced our first real-data effect size** on Tuckute 2024. | On real LH-language-network BOLD, a *trained* LM's mid-layer representation carries **positive unique R²** after subtracting length/position/static-embedding nuisance under contiguous splits, while a same-architecture **untrained** control is **negative** across 3 seeds — best: Qwen2.5-0.5B **+0.036 ± 0.010** (~10% of the 0.353 noise ceiling), gpt2 **+0.020 ± 0.008**. This is exactly the A2-gating result §6 hangs on, now measured on real data. See `experiments/E002_tuckute-encoding-feasibility.md` (full per-model/per-layer numbers), `reports/R03_brain-as-training-signal.md` §5 (E002 = **Q0** of the ladder; the A2 kill-gate from [`00-charter.md`](../00-charter.md)), `reports/R02_datasets-and-code.md` + [`05-dataset-registry.md`](../05-dataset-registry.md) (Tuckute + `beyond-brainscore` anti-confound provenance), learnings L004/L007. **Still open:** Tuckute is ROI-level (coarse, 5 dims); the powered *voxelwise* anchor (LeBel UTS03) is staged but its time-series adapter is pending — R03 Q3. |
...
|---|---|---|
| Layer trend / syntax drives it | Oota 2023 | [`oota-2023_joint-linguistic-processing-brain-lms`](../literature/canonical/oota-2023_joint-linguistic-processing-brain-lms.md) |
| Residual beyond next-word | Merlin & Toneva 2024 | [`merlin-2024_beyond-next-word-brain-alignment`](../literature/canonical/merlin-2024_beyond-next-word-brain-alignment.md) |
| Objective shapes alignment | Aw & Toneva 2023 | [`aw-2023_narrative-summarization-improves-brain-alignment`](../literature/canonical/aw-2023_narrative-summarization-improves-brain-alignment.md) |
| Raw scores can be hollow (modality) | Oota 2024 | [`oota-2024_speech-lms-lack-brain-semantics`](../literature/canonical/oota-2024_speech-lms-lack-brain-semantics.md) |
| Scale↑, saturates ~3B, dissociation | [Oota 2026](../literature/canonical/oota-2026_brain-encoding-scale-compression.md) | [`oota-2026_brain-encoding-scale-compression`](../literature/canonical/oota-2026_brain-encoding-scale-compression.md) |
| Outgrows LN; formal > functional | [AlKhamissi 2025](../literature/canonical/alkhamissi-2025_llms-outgrow-human-language-network.md) | [`alkhamissi-2025_llms-outgrow-human-language-network`](../literature/canonical/alkhamissi-2025_llms-outgrow-human-language-network.md) |
| Scale, not instruction-tuning | [Gao 2024](../literature/canonical/gao-2024_scaling-not-instruction-brain-alignment.md) | [`gao-2024_scaling-not-instruction-brain-alignment`](../literature/canonical/gao-2024_scaling-not-instruction-brain-alignment.md) |
| Confounds / split contamination | [Feghhi 2024](../literature/canonical/feghhi-2024_case-against-over-reliance-brain-scores.md) | [`feghhi-2024_case-against-over-reliance-brain-scores`](../literature/canonical/feghhi-2024_case-against-over-reliance-brain-scores.md) |
| Similarity metric (CKA) | [Kornblith 2019](../literature/canonical/kornblith-2019_cka-similarity-representations.md) | [`kornblith-2019_cka-similarity-representations`](../literature/canonical/kornblith-2019_cka-similarity-representations.md) |
