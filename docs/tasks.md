...
- [ ] **Phase 3 — cutover (G1 built+proven · G2 decided · G3 demonstrated — readiness CONFIRMED S42 by oracle READY-FOR-P3 + premortem; Erfan drives; IRREVERSIBLE; confirm before each step).**
