...
- [ ] **Extended-manuscript deep clean — IN PROGRESS (S33, started 2026-06-22; resumed S46).** Paragraph-by-paragraph with Erfan. **Done:** abstract (conference register, single paragraph, no numbers/CIs, em-dash-free, results deferred to a `\gap`); §4.1 and §4.2 Results rewritten in the reader-facing pattern, with the Q0 CI/voxel-percentage pile separated and Q1 framed as headroom plus quality caveat. **Remaining:** §1 Intro (¶1 teed up; ¶2 = push weak-prior/MAP formalism down to Methods §3.3), §2 related-work (dedup the "empty cell" stated 3×), §3 methods, §4.3+ Results. Per-paragraph suite: `run_checks` + `prose-register-auditor` + taste-reader; real ≥2-auditor clean register verdict at pass END.
