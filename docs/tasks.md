...
- [x] **Arm-level rerun progress confirmed.** The stable rerun saved the first model artifact, `outputs/E016_tribe/phase3/model_artifacts/tribe_gpt2_n95999_s0-2_lam0.1_rerun/seed0_kd_only_lambda0`, then entered `seed=0 arm=tribe_mse`; this is partial-arm progress only, not a result.
