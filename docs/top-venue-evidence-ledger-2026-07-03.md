...
1. **Claim-scope review path:** decide whether the paper should narrow to synthetic brain-like target survival beyond sentence-local text features, without claiming real-brain specificity.
2. **Robustness/rerun path:** predeclare what real-brain endpoint or saved-student rerun would be capable of overturning the Tuckute warning.
